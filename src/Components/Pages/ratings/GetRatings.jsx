...
function GetRatings(props) {
  ...
  useEffect(() => {
    ...
    let url = getBaseUrl() + "api/get/rating";
  ...
  const UpdateRating = (ID) => {
    let id = ID;
    setisloading(true);
    let url = getBaseUrl() + `api/edit/rating/${id}`;
    let temp = {
  ...
  const UpdateRatingData = (row) => {
    setEditDailogOpen(!EditDailogOpen);
    setEditCourseName(row.categoryName);
    //   setEditRating(row.);
    setEditId(row._id);
  };
  ...
  const filterData = ratings.filter((event) => {
          ...
          <Grid className="Component_main_grid mb-3">
            <Grid item md={9}>
              ...
              <button
                ...
                onClick={() => props.history.push("/add-ratings")}
              >
          ...
          >
            ...
            <DialogContent>
              <div class="mb-3">
                ...
                <div class=" col-md-12">
                  <label for="inputPassword4">Edit Rating</label>
                  <input
                    type="text"
                    class="form-control"
