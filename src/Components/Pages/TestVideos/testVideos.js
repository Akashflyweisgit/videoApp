...
function TestVideos(props) {
    ...
    axios
      ...
      .then(
        (res) => {
          ...
          setTestVideo(res.data.getCourse);
        },
  ...
  console.log("course data", testVideo);

  const deleteTestVideo = (row) => {
    let id = row._id;
    setisloading(false);
  ...
  const filterData = testVideo.filter((event) => {
          ...
          <Grid className="Component_main_grid mb-3">
            <Grid item md={9}>
              ...
              <button
                ...
                onClick={() => props.history.push("/create/test/videos")}
              >
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <button
                          type="button"
                          class="btn btn-info mr-4"
                          onClick={() => UpdateTestVideoData(row)}
                        >
