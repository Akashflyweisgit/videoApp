...
function GetFeaturedCourses(props) {
  ...
  useEffect(() => {
    ...
    let url = getBaseUrl() + "api/get/fetured/course";
  ...
  const filterData = featuredCourses.filter((event) => {
      ...
      <div className="home_padding">
        <div className="content_padding">
          <Grid className="Component_main_grid mb-3">
            <Grid item md={9}>
              <h3 className="mb-2"> Featured Courses</h3>
              <button
                type="button"
                class="btn btn-info mr-4"
                onClick={() => props.history.push("/create-featured")}
              >
...
export default HOC(GetFeaturedCourses);
